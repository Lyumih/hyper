...
;
	($.$hyper_heartbeat_beat) = class $hyper_heartbeat_beat extends ($.$mol_page) {
		repo_name(id, next){
			if(next !== undefined) return next;
			return "";
		}
	...
	($mol_mem_key(($.$hyper_heartbeat_beat.prototype), "repo_name"));
	($mol_mem_key(($.$hyper_heartbeat_beat.prototype), "repo_uri"));
	($mol_mem_key(($.$hyper_heartbeat_beat.prototype), "GitHub"));
	($mol_mem_key(($.$hyper_heartbeat_beat.prototype), "Repo"));
	($mol_mem(($.$hyper_heartbeat_beat.prototype), "Repos_list"));
	($mol_mem(($.$hyper_heartbeat_beat.prototype), "Stars"));
	($mol_mem(($.$hyper_heartbeat_beat.prototype), "Commits"));
	($mol_mem(($.$hyper_heartbeat_beat.prototype), "Issues"));
	($mol_mem(($.$hyper_heartbeat_beat.prototype), "Last_update"));
...
;
	($.$hyper_heartbeat_auth) = class $hyper_heartbeat_auth extends ($.$mol_page) {
		email(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		Login_form(){
			...
			(obj.form_fields) = () => ([(this.Email_field()), (this.Password_field())]);
			(obj.buttons) = () => ([(this.Login()), (this.Login_demo_user())]);
			return obj;
		}
		title(){
	...
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "email"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Email_control"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Email_field"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "password"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Password_control"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Password_field"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "login_submit"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Login"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "login_demo"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Login_demo_user"));
	($mol_mem(($.$hyper_heartbeat_auth.prototype), "Login_form"));
...
;
	($.$hyper_heartbeat) = class $hyper_heartbeat extends ($.$mol_view) {
		Theme(){
		...
		Beat(){
			const obj = new this.$.$hyper_heartbeat_beat();
			return obj;
		}
		Boxing_text(){
			const obj = new this.$.$mol_text();
		...
		Menu(){
			...
			(obj.spreads) = () => ({"beat": (this.Beat()), "boxing": (this.Boxing())});
			return obj;
		}
		Auth(){
		...
		sub(){
			return [(this.Menu()), (this.Auth())];
		}
	};
	($mol_mem(($.$hyper_heartbeat.prototype), "Theme"));
	($mol_mem(($.$hyper_heartbeat.prototype), "GitHub"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Lights"));
	($mol_mem(($.$hyper_heartbeat.prototype), "logout"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Logout_icon"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Logout"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Beat"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Boxing_text"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Boxing"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Menu"));
	($mol_mem(($.$hyper_heartbeat.prototype), "Auth"));
